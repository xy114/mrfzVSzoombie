...
export class AssetManager {
  constructor() {
    ...
    this.imagePaths = {
      ...
      peashooter_skin_wishadel_shell: 'resources/special/wisdel-missle-ps.png',
      wisdel_missle_ps: 'resources/special/wisdel-missle-ps.png',
      // New plants
      squash: 'resources/plants/窝瓜.gif',
      ...
      // New zombie default skins
      flag_skin_default_combat: 'resources/zombies/旗帜僵尸.gif',
      flag_skin_default_portrait: 'resources/zombies/旗帜僵尸.gif',
      flag_skin_default_headshot: 'resources/zombies/旗帜僵尸.gif',
      bucket_skin_default_combat: 'resources/zombies/铁桶僵尸.gif',
      bucket_skin_default_portrait: 'resources/zombies/铁桶僵尸.gif',
      bucket_skin_default_headshot: 'resources/zombies/铁桶僵尸.gif',
      clown_skin_default_combat: 'resources/zombies/小丑僵尸.gif',
      clown_skin_default_portrait: 'resources/zombies/小丑僵尸.gif',
      clown_skin_default_headshot: 'resources/zombies/小丑僵尸.gif',
      // Cart default skin
